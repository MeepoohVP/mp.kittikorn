...
function Project() {
  return (
    ...
    >
      ...
      <div className="md:flex justify-center md:px-8 lg:px-48" data-aos="fade-up">
        <Work
          work={covid}
          name="Covid Updated"
      ...
      <div className="text-[#7971EA]/[.75] text-center text-2xl font-semibold mt-8" data-aos = 'fade-up'>
        Certificates
        <ul className="text-left list-disc w-1/2 text-sm mx-auto mt-4 md:w-2/5 lg:w-1/6 font-normal">
            ...
            <a href="https://www.borntodev.com/certificate_online/b8aee05fc1e0053dd4a19c18af99f69c">Introduction to Javascript</a>
            </li>
            <li className="mt-4 md:mt-6 underline decoration-transparent decoration-soild duration-500 hover:decoration-current">
